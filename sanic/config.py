...
DEFAULT_CONFIG = {
    ...
    "SECURITY_HEADERS_CONTENT_SECURITY_POLICY": None,
...
class Config(dict, metaclass=DescriptorMeta):
    ...
    SECURITY_HEADERS_CONTENT_TYPE_OPTIONS: bool
    SECURITY_HEADERS_FRAME_OPTIONS: str | None
    SECURITY_HEADERS_REFERRER_POLICY: str | None
    SECURITY_HEADERS_CONTENT_SECURITY_POLICY: str | None
    SECURITY_HEADERS_HSTS: bool
    SECURITY_HEADERS_HSTS_MAX_AGE: int
    SECURITY_HEADERS_HSTS_INCLUDE_SUBDOMAINS: bool
    SECURITY_HEADERS_HSTS_PRELOAD: bool
    SERVER_NAME: str
